from typing import Optional, List, Set, Iterable, Union, Any
...
def get_sorted_merged_pulls(
    pulls: Iterable[PullRequest], last_release: Optional[GitRelease]
) -> List[PullRequest]:
...
def get_new_contributors(
    old_contributors: Iterable[str], merged_pulls: List[PullRequest]
) -> List[str]:
...
def get_last_release(releases: Iterable[GitRelease]) -> Optional[GitRelease]:
...
def get_first_contribution(
    merged_pulls: List[PullRequest], contributor: str
...
def full_changelog_md(
    repository_name: str, last_tag_name: Optional[str], next_tag_name: str
) -> Optional[str]:
...
def contruct_release_notes(
    repository: Union[Repository, Any], next_tag_name: str
) -> str:
