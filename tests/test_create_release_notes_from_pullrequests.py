import src.release_notes_from_pullrequests as release
...
def test_whats_changed_md():
    ...
    assert whats_changed == [
        '* Feature 8 by @new_contributor_1, @new_contributor_coauthor3 and @new_contributor_coauthor4 in '
        'https://github.com/ada-url/ada/pull/15',
...
def test_new_contributors_md():
    ...
    assert new_contributors_md == [
        '* @new_contributor_2 and @new_contributor_coauthor1 made their first contribution in '
        'https://github.com/ada-url/ada/pull/13',
        '* @new_contributor_coauthor2 made their first contribution in https://github.com/ada-url/ada/pull/14',
        '* @new_contributor_1, @new_contributor_coauthor3 and @new_contributor_coauthor4 made their first '
        'contribution in https://github.com/ada-url/ada/pull/15',
    ]
